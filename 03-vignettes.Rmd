...
```{r shiny1, fig.cap='shinyMixR interface', out.width="80%", fig.align='center', echo=FALSE, message=FALSE}
...
```{r shiny2, fig.cap='Editing model code', out.width="50%", fig.align='center', echo=FALSE, message=FALSE}
...
### Run models
```{r shiny3, fig.cap='Executing model code', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
...
### Parameter estimates
```{r shiny4, fig.cap='View parameter estimates', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
...
```{r shiny5, fig.cap='Creating goodness-of-fit plots', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
...
### Fit plots
```{r shiny6, fig.cap='Creating individual fit plots', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
...
### Scripts
```{r shiny7, fig.cap='Run user defined scripts', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
...
### Results
```{r shiny8, fig.cap='View and combine modeling results', out.width='50%', fig.align='center', echo=FALSE, message=FALSE}
