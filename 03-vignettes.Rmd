...
Some _significant_ applications are demonstrated in this chapter; the vignettes will be discussing the application in in more depth.
...
The `nlmixr` package can be accessed through command line in `R` and `RStudio`, and through an graphical user interface `ShinyMixR` supported by the `nlmixr` team. Both command line and interface support the integration with [`xpose.nlmixr`](https://github.com/nlmixrdevelopment/xpose.nlmixr).

`ShinyMixR` aims to provide a user-friendly tool for `nlmixr` based on [`Shiny`](https://shiny.rstudio.com/), which facilitates a workflow around an `nlmixr` project. It is build as a project-centric, instead of interface-centric, workflow around `nlmixr` from the `R` command line and from a streamlined `Shiny` application. The [`shinydashboard`](https://cran.r-project.org/web/packages/shinydashboard/shinydashboard.pdf) package was used to set up a structure for controlling and tracking runs with an nlmixr project, and was the basis for setting up the modular interface.
...
```{r shiny1, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r shiny2, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
### Run models
```{r shiny3, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
### Parameter estimates
```{r shiny4, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r shiny5, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
### Fit plots
```{r shiny6, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
### Scripts
```{r shiny7, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
### Results
```{r shiny8, fig.cap='', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
