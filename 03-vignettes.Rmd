...
`xpose.nlmixr` was written to provide an interface between `nlmixr` and the NONMEM-centric [`xpose`](https://github.com/UUPharmacometrics/xpose) model diagnostics package developed by Ben Guiastrennec and colleagues at Uppsala University. 
...
This way it is possible to work on data and models separately and plug them in to `shinyMixR` at a later stage. 
